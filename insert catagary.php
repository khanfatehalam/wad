...
if(isset($_POST['insert_pro'])){
    ...
    $insert_product = "insert into products (pro_title)  VALUES ('$pro_title');";
...
<div class="container">
    ...
    <form action="insert%20catagary.php" method="post" enctype="multipart/form-data">
        <div class="row">
        ...
        <div class="row my-3">
            ...
            <div class="col-sm-9 col-md-8 col-lg-4 col-xl-4">
                <button type="submit" name="insert_pro" class="btn btn-primary btn-block"><i class="fas fa-plus"></i> Insert Category </button>
            </div>
        </div>
    </form>
</div>
